...
-- These are owned by @mastra/pg and managed by the Mastra runtime.
-- Do not modify column definitions — regenerate by running `mastra build` against a fresh DB.
-- trigger_set_timestamps() is defined in 20260426000000_foreman_core.sql (runs first alphabetically)
