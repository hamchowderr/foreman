...
const AGENT_ENV_KEYS = [
  "MODEL_DEFAULT", "MODEL_FAST", "MODEL_HEAVY",
  "FOREMAN_MODEL", "DISCOVERY_MODEL", "EXECUTION_MODEL", "SUPERVISOR_MODEL", "HISTORY_MODEL",
  ...
  "EXECUTION_TEMPERATURE", "EXECUTION_MAX_OUTPUT_TOKENS", "EXECUTION_TOP_P",
  "SUPERVISOR_TEMPERATURE", "SUPERVISOR_MAX_OUTPUT_TOKENS", "SUPERVISOR_TOP_P",
  "HISTORY_TEMPERATURE", "HISTORY_MAX_OUTPUT_TOKENS", "HISTORY_TOP_P",
  "FOREMAN_PROMPT_CACHING", "DISCOVERY_PROMPT_CACHING", "EXECUTION_PROMPT_CACHING",
  "SUPERVISOR_PROMPT_CACHING", "HISTORY_PROMPT_CACHING",
  "FOREMAN_TOOL_CACHING", "DISCOVERY_TOOL_CACHING", "EXECUTION_TOOL_CACHING",
  "SUPERVISOR_TOOL_CACHING", "HISTORY_TOOL_CACHING",
] as const;
