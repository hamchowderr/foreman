...
const _CodeBlockHeader = ({ children, className, ...props }: HTMLAttributes<HTMLDivElement>) => (
  <div
    className={cn(
...
const _CodeBlockTitle = ({ children, className, ...props }: HTMLAttributes<HTMLDivElement>) => (
...
const _CodeBlockActions = ({ children, className, ...props }: HTMLAttributes<HTMLDivElement>) => (
