      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <Reveal>
          <div className="relative rounded-2xl border border-border/60 overflow-hidden">
            <div
              aria-hidden
              className="absolute inset-0 bg-gradient-to-br from-surface via-background to-accent/5"
            />
            <div
              aria-hidden
              className="absolute top-0 right-0 w-[50vw] max-w-[400px] h-[50vw] max-h-[400px] bg-accent/[0.04] rounded-full blur-[100px]"
            />
