...
import { Check, Brain, MessageSquare } from "@/components/icons/hi";
...
const SCENES: Scene[] = [
  {
    ...
    trace: [
      ...
      { tool: "list-input-fields", args: "send-email", result: "to · cc · subject · body · attachment", elapsedMs: 71 },
      { tool: "run-action", args: 'drive-find-file, "Q3 deck"', result: "Q3-Review.pdf", elapsedMs: 348 },
    ],
  },
  {
    ...
    trace: [
      { tool: "search-history", args: '"priya bug slack"', result: 'slack #bugs · "form submit fails on Safari 17"', elapsedMs: 221 },
      { tool: "search-actions", args: '"trello card"', result: "trello · create-card", elapsedMs: 88 },
      { tool: "list-input-fields", args: "create-card", result: "board · list · name · description", elapsedMs: 60 },
      { tool: "list-input-field-choices", args: "board", result: "Personal · Engineering · Roadmap", elapsedMs: 134 },
      { tool: "list-input-field-choices", args: 'list (board="Engineering")', result: "Inbox · In Progress · Done", elapsedMs: 102 },
    ],
  },
  {
    ...
    trace: [
      ...
      { tool: "run-action", args: 'find-invoice, "INV-2091"', result: "Acme Corp · $12,400 · paid", elapsedMs: 312 },
      { tool: "list-input-field-choices", args: "expand", result: "line_items (2), customer, charge", elapsedMs: 68 },
      { tool: "run-action", args: 'find-invoice, id="INV-2091", expand=["charge"]', result: "ch_3Nx…KZ · paid Mar 28", elapsedMs: 288 },
    ],
  },
];
